        ...
        <div className="responsive-page">
          <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            >
              ...
              <div className="min-w-0"><p className="command-eyebrow">Catálogo operacional</p><h1 className="responsive-heading text-slate-950 dark:text-white">Serviços</h1><p className="command-page-description">Padronize soluções, valores e execução da bancada.</p></div>
            </motion.div>
