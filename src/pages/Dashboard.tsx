...
type DashboardSummary = {
  ...
  financial: { recebido_mes: number; a_receber_mes: number; vencido: number } | null;
...
export function Dashboard() {
  ...
  const metrics = summary ? [
    ...
    isFinancial
      ? { label: 'A receber no mês', value: formatCurrency(summary.financial!.a_receber_mes), detail: `${formatCurrency(summary.financial!.vencido)} vencido`, icon: WalletCards, tone: 'emerald', href: '/ordens?financeiro=aberto' }
