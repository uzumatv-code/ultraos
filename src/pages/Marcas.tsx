          ...
          <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            >
              <motion.div 
                ...
                className="h-11 w-11 sm:h-12 sm:w-12 shrink-0 bg-gradient-to-br from-orange-500 to-pink-600 rounded-xl flex items-center justify-center shadow-lg shadow-orange-500/30"
              >
                <Bookmark className="w-6 h-6 text-white" />
              </motion.div>
              <h1 className="responsive-heading bg-gradient-to-r from-orange-600 to-pink-600 dark:from-orange-400 dark:to-pink-400 bg-clip-text text-transparent">
                Marcas
              </h1>
            </motion.div>
            ...
            >
              ...
              <motion.button
                ...
                className="w-full sm:w-auto px-4 py-2 bg-gradient-to-r from-orange-600 to-pink-600 hover:from-orange-700 hover:to-pink-700 text-white font-medium rounded-lg transition-all duration-300 flex items-center justify-center gap-2 shadow-lg shadow-orange-500/30 dark:shadow-orange-500/20"
              >
