...
const createTables = [
  ...
  `CREATE TABLE IF NOT EXISTS remarketing_campanhas (
    ...
    mensagem text NOT NULL,
    ultima_execucao_em varchar(50) DEFAULT NULL,
    created_at varchar(50) NOT NULL,
    updated_at varchar(50) NOT NULL,
  ...
  `CREATE TABLE IF NOT EXISTS comunicacao_preferencias (
    ...
    user_id varchar(36) NOT NULL,
    cliente_id varchar(36) NOT NULL,
    lembretes_manutencao_autorizado tinyint(1) NOT NULL DEFAULT 0,
    origem_consentimento varchar(100) DEFAULT NULL,
    consentido_em varchar(50) DEFAULT NULL,
    descadastrado_em varchar(50) DEFAULT NULL,
    motivo_descadastro varchar(255) DEFAULT NULL,
    created_at varchar(50) NOT NULL,
    updated_at varchar(50) NOT NULL,
  ...
  `CREATE TABLE IF NOT EXISTS remarketing_lembretes (
    ...
    instrumento_id varchar(36) DEFAULT NULL,
    equipamento_id varchar(36) DEFAULT NULL,
    conversa_id varchar(36) DEFAULT NULL,
    whatsapp_mensagem_id varchar(36) DEFAULT NULL,
    telefone varchar(30) DEFAULT NULL,
    mensagem text DEFAULT NULL,
    status varchar(50) NOT NULL DEFAULT 'pendente',
    tentativas int NOT NULL DEFAULT 0,
    data_envio varchar(50) DEFAULT NULL,
    respondido_em varchar(50) DEFAULT NULL,
    convertido_em varchar(50) DEFAULT NULL,
    ordem_conversao_id varchar(36) DEFAULT NULL,
    mensagem_erro text DEFAULT NULL,
    created_at varchar(50) NOT NULL,
    updated_at varchar(50) NOT NULL,
